          ...
          <div className="md:border-b xl:border-none md:border-gray md:pt-4 md:pb-8 xl:pt-0 xl:pb-0">
            <div className="pt-4 xl:pt-2 px-4 md:px-6 md:flex md:justify-between">
              <div className="relative md:flex md:items-center">
                <div className="block w-full px-0 text-xxs tracking-wider font-semibold md:mr-3">FROM</div>
                <DatePicker
                  selected={startDate}
              ...
              <div className="relative md:flex md:items-center">
                <div className="pt-4 md:pt-0 block w-full px-0 text-xxs tracking-wider font-semibold md:mr-3 xl:ml-8">TO</div>
                <DatePicker
                  selected={endDate}
