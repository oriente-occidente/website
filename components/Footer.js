  ...
  return (
    <footer className="bg-white container" aria-labelledby="footer-heading">
      ...
      <div className="py-6 lg:pt-16 xl:px-0">
        ...
        <div className="md:grid md:grid-cols-2 md:mt-8 md:gap-8 md:border-t md:border-gray-200">
          <div className="">
          ...
          <div className="mt-8 mb-4 border-t border-gray-200 pt-8 md:border-0 md:mt-0 xl:flex xl:justify-end">
            <p className="text-xs text-gray-400 inline-block xl:text-center">
              Trasparenza
            </p>
            <p className="text-xs text-gray-400 ml-8 inline-block xl:text-center">
              Accountability
            </p>
          </div>
        </div>
