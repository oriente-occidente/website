...
module.exports = async function (client) {
  ...
  console.log(
    'Create Single asset field "Over Image" (`over_image`) in model "Workshop Category" (`workshop_category`)'
  );
  newFields["7960057"] = await client.fields.create(newItemTypes["1333068"], {
    label: "Over Image",
    field_type: "file",
    api_key: "over_image",
  ...
  newFields["7960483"] = await client.fields.create(newItemTypes["1392153"], {
    label: "link",
    field_type: "string",
    api_key: "link",
    appearance: {
  ...
  await client.itemTypes.update(newItemTypes["1333068"], {
    ...
    image_preview_field: newFields["7960057"],
  });
  ...
  await client.menuItems.update(newMenuItems["683440"], { position: 0 });
};
