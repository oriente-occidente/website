...
query programResults($locale: SiteLocale, $start: Date) {
  festivalEvents: allEvents(locale: $locale, filter: {isFestival: {eq: true}, startDate: {gte: $start}}, orderBy: startDate_DESC) {
    ${sharedPreviewBlock}
    category {
      id
      slug
  ...
  otherEvents: allEvents(locale: $locale, filter: {isFestival: {eq: false}, startDate: {gte: $start}}, orderBy: startDate_DESC) {
    ${sharedPreviewBlock}
    category {
      id
      slug
  ...
  workshops: allWorkshops(locale: $locale, filter: {isWorkshop: {eq: true}, startDate: {gte: $start}}, orderBy: startDate_DESC) {
    ${sharedPreviewBlock}
    category {
      id
      slug
  ...
  courses: allWorkshops(locale: $locale, filter: {isWorkshop: {eq: false}, startDate: {gte: $start}}, orderBy: startDate_DESC) {
    ${sharedPreviewBlock}
    category {
      id
      slug
...
query otherEvents($locale: SiteLocale) {
  otherEvents: allEvents(locale: $locale, filter: {isFestival: {eq: false}}, orderBy: startDate_DESC) {
    authors
    location
    ${sharedPreviewBlock}
    category {
...
query workshops($locale: SiteLocale) {
  workshops: allWorkshops(locale: $locale, filter: {isWorkshop: {eq: true}}, orderBy: startDate_DESC) {
    ${sharedPreviewBlock}
    category {
      id
      slug
...
query courses($locale: SiteLocale) {
  courses: allWorkshops(locale: $locale, filter: {isWorkshop: {eq: false}}, orderBy: startDate_DESC) {
    ${sharedPreviewBlock}
    category {
      id
      slug
...
query associatedArtistsByYear($locale: SiteLocale, $years: [ItemId]) {
  associatedArtists: allArtists(locale: $locale, filter: {associatedArtist: {exists: true, anyIn: $years}}, orderBy: _createdAt_ASC) {
    artisticResidence {
      id
      year
    }
