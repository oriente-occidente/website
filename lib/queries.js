...
query projects($locale: SiteLocale) {
  projects: allProjects(locale: $locale, orderBy: startDate_DESC) {
    ${sharedPreviewBlock}
    category {
      id
      slug
...
query newsIndex($locale: SiteLocale) {
  newsIndex: allNews(locale: $locale, orderBy: startDate_DESC) {
    ${sharedPreviewBlock}
    category {
      id
      slug
...
query program($locale: SiteLocale, $start: Date, $end: Date) {
  festivalEvents: allEvents(locale: $locale, filter: {isFestival: {eq: true}, startDate: {gte: $start, lt: $end}}, orderBy: startDate_DESC, first: 100) {
    ${sharedPreviewBlock}
    category {
      id
      slug
  ...
  workshops: allWorkshops(locale: $locale, filter: {isWorkshop: {eq: true}, startDate: {gte: $start, lt: $end}}, orderBy: startDate_DESC, first: 100){
    ${sharedPreviewBlock}
    category {
      id
      slug
  ...
  courses: allWorkshops(locale: $locale, filter: {isWorkshop: {eq: false}, startDate: {gte: $start, lt: $end}}, orderBy: startDate_DESC, first: 100){
    ${sharedPreviewBlock}
    category {
      id
      slug
...
query otherEvents($locale: SiteLocale) {
  otherEvents: allEvents(locale: $locale, filter: {isFestival: {eq: false}}, orderBy: startDate_DESC, first: 100) {
    authors
    location
    ${sharedPreviewBlock}
    category {
...
query workshops($locale: SiteLocale) {
  workshops: allWorkshops(locale: $locale, filter: {isWorkshop: {eq: true}}, orderBy: startDate_DESC, first: 100) {
    ${sharedPreviewBlock}
    category {
      id
      slug
...
query courses($locale: SiteLocale) {
  courses: allWorkshops(locale: $locale, filter: {isWorkshop: {eq: false}}, orderBy: startDate_DESC, first: 100) {
    ${sharedPreviewBlock}
    category {
      id
      slug
...
query associatedArtists($locale: SiteLocale) {
  associatedArtists: allArtists(locale: $locale, filter: {associatedArtist: {exists: true}}, orderBy: _createdAt_ASC, first: 100) {
    ${sharedPreviewBlock}
    artisticResidence {
      id
      year
...
//   associatedArtists: allArtists(locale: $locale, filter: {associatedArtist: {exists: true, anyIn: $years}}, orderBy: _createdAt_ASC, first: 100) {
//     artisticResidence {
//       id
//       year
//     }
...
query artisticResidences($locale: SiteLocale) {
  artisticResidences: allArtists(locale: $locale, filter: {artisticResidence: {exists: true}}, orderBy: _createdAt_ASC, first: 100) {
    ${sharedPreviewBlock}
    artisticResidence {
      id
      year
