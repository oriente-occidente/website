...
query associatedArtists($locale: SiteLocale) {
  associatedArtists: allArtists(locale: $locale, filter: {associatedArtist: {exists: true}}, orderBy: _firstPublishedAt_DESC, first: 100) {
    ${sharedPreviewBlock}
    startDate: _firstPublishedAt
    artisticResidence {
      id
...
query artisticResidences($locale: SiteLocale) {
  artisticResidences: allArtists(locale: $locale, filter: {artisticResidence: {exists: true}}, orderBy: _firstPublishedAt_DESC, first: 100) {
    ${sharedPreviewBlock}
    startDate: _firstPublishedAt
    artisticResidence {
      id
