...
const imgFrag = `fragment imgFrag on ResponsiveImage {
    aspectRatio
    base64
    height
    sizes
...
//require imgFrag
const imageBlockFrag = `fragment imageBlockFrag on ImageBlockRecord {
  id
  image {
...
//require imgFrag
const galleryFrag = `fragment galleryFrag on GalleryRecord {
  id
  images {
...
const videoFrag = `fragment videoFrag on VideoBlockRecord {
  id
  autoPlay
  controls
  loop
