...
query program($locale: SiteLocale, $start: Date, $end: Date) {
  festivalEvents: allEvents(locale: $locale, filter: {isFestival: {eq: true}, startDate: {gte: $start, lt: $end}}, orderBy: startDate_DESC) {
    ${sharedPreviewBlock}
    category {
      id
      slug
  ...
  otherEvents: allEvents(locale: $locale, filter: {isFestival: {eq: false}, startDate: {gte: $start, lt: $end}}, orderBy: startDate_DESC) {
    ${sharedPreviewBlock}
    category {
      id
      slug
  ...
  workshops: allWorkshops(locale: $locale, filter: {isWorkshop: {eq: true}, startDate: {gte: $start, lt: $end}}, orderBy: startDate_DESC) {
    ${sharedPreviewBlock}
    category {
      id
      slug
  ...
  courses: allWorkshops(locale: $locale, filter: {isWorkshop: {eq: false}, startDate: {gte: $start, lt: $end}}, orderBy: startDate_DESC) {
    ${sharedPreviewBlock}
    category {
      id
      slug
