...
export function formatDate(str, locale = 'it', fmt = 'MMM DD YYYY') {
...
export function showDates(dates, locale) {
  ...
  const fmt = choosen.isDaily ? 'MMM DD YYYY HH:mm' : 'MMM DD YYYY';
  return formatDate(choosen.startTime, locale, fmt);
}
